  ...
  return (
    <div className="bg-page">
      ...
      <PageHeader eyebrow="Reserve The Band" title={<em>Booking</em>}
        lede="Three steps to put the Velocity Band on your stage. No form mazes. No bots. An actual person reads every inquiry." />
      ...
      <section className="bg-section narrow" style={{ paddingTop: 20, textAlign: 'center' }}>
        ...
        <h2 style={{ fontFamily: 'Playfair Display, serif', fontStyle: 'italic', fontSize: 44, color: 'var(--gold)', fontWeight: 400, marginBottom: 18 }}>
          booking@barrygolden.com
        </h2>
